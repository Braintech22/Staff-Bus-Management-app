...
function Herosection() {
    return ( <Carousel fade >
        ...
        src = "https://unsplash.com/photos/w8CcH9Md4vE"
        alt = "First slide" />
        <Carousel.Caption >
        ...
        <Carousel.Caption >
        <h3 > Third slide label </h3> <p>Praesent commodo cursus magna, vel scelerisque nisl consectetur. </p> </Carousel.Caption> </Carousel.Item> </Carousel>
    );
}
